...
def generate_comfy_json(n_value, subject_name, output_filename):
    ...
    workflow_template = {
        ...
        "58": {"inputs": {"value": f"/content/ComfyUI/input/qwen/{subject_name}"}, "class_type": "easy string", "_meta": {"title": "srcdir"}},
        "60": {"inputs": {"value": f"/content/ComfyUI/input/qwen/{subject_name}/dupe"}, "class_type": "easy string", "_meta": {"title": "dupedir"}},
        ...
        "257": {"inputs": {"text": ["256", 0], "base_dir": "/content/ComfyUI/input", "start_index": 0, "count": 12, "cols": 4, "thumb_size": 1024, "padding": 8, "recursive": True}, "class_type": "ScoreGridPreviewFromText", "_meta": {"title": "Score Grid Preview From Text"}},
        "258": {"inputs": {"images": ["257", 0]}, "class_type": "PreviewImage", "_meta": {"title": "Preview Image"}},
        "259": {"inputs": {"text_0": "files=2 | shown=2 | missing=0 | recursive=True | base_dir=/content/ComfyUI/input", "text": ["257", 1]}, "class_type": "ShowText|pysssss", "_meta": {"title": "Show Text 🐍"}},
